...
<body>
    ...
    <div class="jumbotron jumbotron-fluid bg-light  mb-0" id="news">
        <div class="container">
            <h2 class="display-4 text-center">Contact us</h1>
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <p> <i class='fa fa-phone'></i> +977 98161164611</p>
                        <p> <i class='fa fa-envelope'></i> United.limited@gmail.com</p>
                        <a href="WWW.UnitedLimited.com.np" class="t-black"> <p> <i class='fa fa-globe'></i> WWW.UnitedLimited.com.np</p></a>
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"])) {
                    ...
                    if (mail($to, $subject, $message, $headers)) {
                        ...
                        echo "<div class='alert alert-danger'> There was an error sending your fedback. </div>";
                    }
                }
                ?>
        </div>
